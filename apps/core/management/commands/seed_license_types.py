...
RENAMES = {
    ...
    ('KS', 'addon_type', 'Deer Archery Tag (OTC)'): 'Deer Archery Tag',
    ('KS', 'addon_type', 'Antlerless Whitetail Tag (OTC)'): 'Antlerless Whitetail Tag',
    ('KY', 'addon_type', 'Elk Draw Permit'): 'Elk Permit',
